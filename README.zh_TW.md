...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=vaultec">JetBrains</a> 為本項目提供免費的開源開發許可證</strong>
</p>
...
📖 更多部署方式請參考 [部署指南](https://vaultec.ai/zh/docs/installation)
...
### 📖 [官方文件](https://vaultec.ai/zh/docs) | [原始碼倉庫](https://github.com/adm73/infra_vaultec)
...
| 分類 | 連結 |
|------|------|
| 🚀 部署指南 | [安裝文件](https://vaultec.ai/zh/docs/installation) |
| ⚙️ 環境配置 | [環境變數](https://vaultec.ai/zh/docs/installation/config-maintenance/environment-variables) |
| 📡 接口文件 | [API 文件](https://vaultec.ai/zh/docs/api) |
| ❓ 常見問題 | [FAQ](https://vaultec.ai/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://vaultec.ai/zh/docs/support/community-interaction) |

---

## ✨ 主要特性

> 詳細特性請參考 [特性說明](https://vaultec.ai/zh/docs/guide/wiki/basic-concepts/features-introduction)
...
- 📱 Telegram 授權登錄
- 🔑 OIDC 統一認證
- 🔍 Key 查詢使用額度（配合 [vaultec-key-tool](https://github.com/adm73/infra_vaultec-key-tool)）
...
> 詳情請參考 [接口文件 - 閘道接口](https://vaultec.ai/zh/docs/api)

| 模型類型 | 說明 | 文件 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文件](https://vaultec.ai/zh/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文件](https://vaultec.ai/zh/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [文件](https://vaultec.ai/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [文件](https://vaultec.ai/api/suno-music) |
| 🔄 Rerank | Cohere、Jina | [文件](https://vaultec.ai/zh/docs/api/ai-model/rerank/create-rerank) |
| 💬 Claude | Messages 格式 | [文件](https://vaultec.ai/zh/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini 格式 | [文件](https://vaultec.ai/zh/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow 模式 | - |
...
- [響應接口 (Responses)](https://vaultec.ai/zh/docs/api/ai-model/chat/openai/createresponse)
- [圖像接口 (Image)](https://vaultec.ai/zh/docs/api/ai-model/images/openai/post-v1-images-generations)
- [音訊接口 (Audio)](https://vaultec.ai/zh/docs/api/ai-model/audio/openai/create-transcription)
- [影片接口 (Video)](https://vaultec.ai/zh/docs/api/ai-model/audio/openai/createspeech)
...
- [即時對話 (Realtime)](https://vaultec.ai/zh/docs/api/ai-model/realtime/createrealtimesession)
...
> [!TIP]
> **最新版 Docker 鏡像：** `ghcr.io/adm73/infra_vaultec:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope 應用名                                        | `vaultec` |
...
| `HOSTNAME` | Pyroscope 標籤裡的主機名                                          | `vaultec` |

📖 **完整配置：** [環境變數文件](https://vaultec.ai/zh/docs/installation/config-maintenance/environment-variables)
...
| 項目 | 說明 |
|------|------|
| [vaultec-key-tool](https://github.com/adm73/infra_vaultec-key-tool) | Key 額度查詢工具 |
| [vaultec-horizon](https://github.com/adm73/infra_vaultec-horizon) | Vaultec 高性能優化版 |
...
| 📘 常見問題 | [FAQ](https://vaultec.ai/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://vaultec.ai/zh/docs/support/community-interaction) |
| 🐛 回饋問題 | [問題回饋](https://vaultec.ai/zh/docs/support/feedback-issues) |
| 📚 完整文件 | [官方文件](https://vaultec.ai/zh/docs) |
...
**[官方文件](https://vaultec.ai/zh/docs)** • **[問題回饋](https://github.com/adm73/infra_vaultec/issues)** • **[最新發布](https://github.com/adm73/infra_vaultec/releases)**
