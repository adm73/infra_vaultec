# Vaultec Electron Desktop App

This directory contains the Electron wrapper for Vaultec, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., vaultec-macos)
cp ../vaultec-macos ../vaultec
```
...
- Store database in `../data/vaultec.db`
...
### Database Location
- **Development**: `../data/vaultec.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Vaultec/data/`
  - Windows: `%APPDATA%/Vaultec/data/`
  - Linux: `~/.config/Vaultec/data/`
