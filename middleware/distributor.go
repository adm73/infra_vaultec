...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.VaultecError {
	...
	key, index, vaultecError := channel.GetNextEnabledKey()
	if vaultecError != nil {
		return vaultecError
	}
