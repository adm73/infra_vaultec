...
// 任一步骤失败时原子回滚已完成的步骤。
func (s *BillingSession) preConsume(c *gin.Context, quota int) *types.VaultecError {
...
func NewBillingSession(c *gin.Context, relayInfo *relaycommon.RelayInfo, preConsumedQuota int) (*BillingSession, *types.VaultecError) {
	if relayInfo == nil {
	...
	// 钱包路径需要先检查用户额度
	tryWallet := func() (*BillingSession, *types.VaultecError) {
	...
	trySubscription := func() (*BillingSession, *types.VaultecError) {
