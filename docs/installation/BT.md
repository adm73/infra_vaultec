...
本文档提供使用宝塔面板 Docker 功能部署 Vaultec 的图文教程。

> 📖 官方文档：[宝塔面板部署](https://vaultec.ai/zh/docs/installation/deployment-methods/bt-docker-installation)
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/vaultec`
...
services:
  vaultec:
    image: ghcr.io/adm73/infra_vaultec:latest
    container_name: vaultec
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
- [官方文档](https://vaultec.ai/zh/docs/installation)
- [环境变量配置](https://vaultec.ai/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://vaultec.ai/zh/docs/support/faq)
- [GitHub 仓库](https://github.com/adm73/infra_vaultec)
