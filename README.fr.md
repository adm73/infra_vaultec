...
<p align="center">
  <a href="https://raw.githubusercontent.com/adm73/infra_vaultec/main/LICENSE">
    <img src="https://img.shields.io/github/license/adm73/infra_vaultec?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/adm73/infra_vaultec/releases/latest">
    <img src="https://img.shields.io/github/v/release/adm73/infra_vaultec?color=brightgreen&include_prereleases" alt="version">
  </a><!--
...
<p align="center">
  ...
  <br>
  <a href="https://github.com/adm73/infra_vaultec" target="_blank">
    <img src="https://api.hellogithub.com/v1/widgets/recommend.svg?rid=539ac4217e69431684ad4a0bab768811&claim_uid=tbFPfKIDHpc4TzR" alt="Featured｜HelloGitHub" style="width: 250px; height: 54px;" width="250" height="54" />
  </a><!--
  --><a href="https://www.producthunt.com/products/vaultec/launches/vaultec?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-vaultec" target="_blank" rel="noopener noreferrer">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1047693&theme=light&t=1769577875005" alt="Vaultec - All-in-one AI asset management gateway. | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" />
  </a>
</p>
...
<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=vaultec">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://vaultec.ai/en/docs/installation)
...
### 📖 [Documentation officielle](https://vaultec.ai/en/docs) | [Dépôt source](https://github.com/adm73/infra_vaultec)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://vaultec.ai/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://vaultec.ai/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://vaultec.ai/en/docs/api) |
| ❓ FAQ | [FAQ](https://vaultec.ai/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://vaultec.ai/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://vaultec.ai/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- 🔍 Requête de quota d'utilisation de clé (avec [vaultec-key-tool](https://github.com/adm73/infra_vaultec-key-tool))

### 🚀 Fonctionnalités avancées

**Prise en charge des formats d'API:**
- ⚡ [OpenAI Responses](https://vaultec.ai/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://vaultec.ai/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
...
- 🔄 [Modèles Rerank](https://vaultec.ai/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de passerelle](https://vaultec.ai/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://vaultec.ai/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://vaultec.ai/en/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [Documentation](https://vaultec.ai/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [Documentation](https://vaultec.ai/api/suno-music) |
| 🔄 Rerank | Cohere, Jina | [Documentation](https://vaultec.ai/en/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Format Messages | [Documentation](https://vaultec.ai/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://vaultec.ai/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://vaultec.ai/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://vaultec.ai/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://vaultec.ai/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://vaultec.ai/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://vaultec.ai/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://vaultec.ai/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://vaultec.ai/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://vaultec.ai/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://vaultec.ai/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://vaultec.ai/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `ghcr.io/adm73/infra_vaultec:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `vaultec` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `vaultec` |

📖 **Configuration complète:** [Documentation des variables d'environnement](https://vaultec.ai/en/docs/installation/config-maintenance/environment-variables)
...
2. Recherchez **Vaultec** dans le magasin d'applications
...
| Projet | Description |
|------|------|
| [vaultec-key-tool](https://github.com/adm73/infra_vaultec-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [vaultec-horizon](https://github.com/adm73/infra_vaultec-horizon) | Version optimisée haute performance de Vaultec |
...
| 📘 FAQ | [FAQ](https://vaultec.ai/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://vaultec.ai/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://vaultec.ai/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://vaultec.ai/en/docs) |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=adm73/infra_vaultec&type=Date)](https://star-history.com/#adm73/infra_vaultec&Date)
...
### 💖 Merci d'utiliser Vaultec

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://vaultec.ai/en/docs)** • **[Commentaires sur les problèmes](https://github.com/adm73/infra_vaultec/issues)** • **[Dernière version](https://github.com/adm73/infra_vaultec/releases)**
