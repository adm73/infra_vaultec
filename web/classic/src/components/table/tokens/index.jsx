...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-vaultec-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-vaultec-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-vaultec-container') return true;
      return (
