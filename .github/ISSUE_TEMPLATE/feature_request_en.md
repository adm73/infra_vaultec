...
- Docs: https://docs.vaultec.ai/
- For usage questions, check first: https://github.com/adm73/infra_vaultec
...
- [ ] **Non-duplicate issue:** I have searched existing [Issues](https://github.com/adm73/infra_vaultec/issues?q=is%3Aissue) and confirmed there are no similar issues.
- [ ] **Read this first:** I have fully read the section above, reviewed the docs at https://docs.vaultec.ai/ and the project README, and asked AI first, confirming this is not a usage, configuration, or integration question, and that the current version cannot meet my needs.
