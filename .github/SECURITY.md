...
> [!IMPORTANT]
> **Bulk Reporting Policy:** If you need to submit multiple vulnerability reports in bulk, **open one private draft security advisory first** so we can coordinate the review. Uncoordinated bulk submissions may be closed without review.
>
...
To report a security issue, please use the GitHub Security Advisories tab to "[Open a draft security advisory](https://github.com/adm73/infra_vaultec/security/advisories/new)". This is the preferred method as it provides a built-in private communication channel.

GitHub Security Advisories are the only supported reporting channel for this
repository. Do not include vulnerability details in a public issue.
...
When deploying and using Vaultec, we recommend following these security best practices:
