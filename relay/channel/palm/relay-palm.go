...
func palmStreamHandler(c *gin.Context, resp *http.Response) (*types.VaultecError, string) {
	responseText := ""
...
func palmHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.VaultecError) {
	responseBody, err := io.ReadAll(service.LimitUpstreamResponseBody(resp.Body))
	if err != nil {
