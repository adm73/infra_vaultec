...
func cohereStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.VaultecError) {
...
func cohereHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.VaultecError) {
	createdTime := common.GetTimestamp()
...
func cohereRerankHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.VaultecError) {
	responseBody, err := io.ReadAll(service.LimitUpstreamResponseBody(resp.Body))
	if err != nil {
		return nil, types.NewError(err, types.ErrorCodeBadResponseBody)
	}
