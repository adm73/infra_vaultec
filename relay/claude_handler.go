...
func ClaudeHelper(c *gin.Context, info *relaycommon.RelayInfo) (vaultecError *types.VaultecError) {
	...
	if !model_setting.GetGlobalSettings().PassThroughRequestEnabled &&
		...
		usage, vaultecErr := chatCompletionsViaResponses(c, info, adaptor, openAIRequest)
		if vaultecErr != nil {
			return vaultecErr
		}
